...
import com.ums.application.utility.OtpUtil;
import com.ums.domain.entity.otp.Otp;
import com.ums.domain.entity.otp.OtpRequest;
import com.ums.domain.repo.otp.OtpRepo;
import com.ums.domain.repo.otp.OtpRequestRepo;
...
public class OtpService implements IOtpService {
    ...
    public GenerateOtpResponse generateOtpAndProcess(GenerateOtpRequest generateOtpRequest) {
        ...
        return generateOtpForChannels(savedOtpRequest);
    }

    private GenerateOtpResponse generateOtpForChannels(OtpRequest otpRequest) {
        ...
        if (deliveryChannel.equals(LookUpConstants.OTP_DELIVERY_CHANNEL_BOTH) ||
            ...
            Otp savedEmailOtp = createAndSaveOtp(otpRequest, LookUpConstants.OTP_DELIVERY_CHANNEL_EMAIL);
        ...
        if (deliveryChannel.equals(LookUpConstants.OTP_DELIVERY_CHANNEL_BOTH) ||
            ...
            Otp savedMobileOtp = createAndSaveOtp(otpRequest, LookUpConstants.OTP_DELIVERY_CHANNEL_MOBILE);
    ...
    private Otp createAndSaveOtp(OtpRequest otpRequest, String deliveryChannel) {
        Otp otp = Otp.builder()
    ...
    public RegenerateOtpResponse regenerateOtpAndProcess(RegenerateOtpRequest regenerateOtpRequest) {
        ...
        expireExistingOtps(otpRequest, requestedChannel);

        // Generate new OTP for the requested channel
        Otp newOtp = createAndSaveOtp(otpRequest, requestedChannel);
     ...
     */
    private void expireExistingOtps(OtpRequest otpRequest, String deliveryChannel) {
